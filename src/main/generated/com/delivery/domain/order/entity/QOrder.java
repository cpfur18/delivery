...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = 655654784L;
    ...
    public final EnumPath<com.delivery.domain.order.enums.OrderStatus> status = createEnum("status", com.delivery.domain.order.enums.OrderStatus.class);
